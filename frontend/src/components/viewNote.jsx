    ...
    return (
      <div className="flex items-center justify-center h-screen bg-gray-200">
        <div className="bg-white p-8 rounded-md shadow-md w-96 text-center">
          <h2 className="text-xl font-semibold mb-4 text-black">Encrypted Note</h2>
          <p className="text-sm text-gray-500 mb-4">This note is protected with End-to-End Encryption.</p>
          <input 
            type="password" 
